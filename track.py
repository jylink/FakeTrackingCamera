...
from control import *
from utils import plot_text, plot_cross
...
def detect(save_img=True):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            # Stream results
            if view_img:
                plot_text((0, 20), im0, text=f"valid {valid}/{max_valid}", color=(255,0,0))
                # if cx != -1 and cy != -1:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolov3/cfg/yolov3-tiny.cfg', help='*.cfg path')
    parser.add_argument('--names', type=str, default='yolov3/data/coco.names', help='*.names path')
    parser.add_argument('--weights', type=str, default='yolov3/weights/yolov3-tiny.pt', help='path to weights file')
    parser.add_argument('--source', type=str, default='fake', help='source')  # input file/folder, 0 for webcam
